...
Examples
--------
$ ipyrad2 analysis snpex -d assembly.hdf5 -o OUT/
$ ipyrad2 analysis snpex -d assembly.hdf5 -o OUT/ -n SNPSET --seed 123 --phylip
$ ipyrad2 analysis snpex -d assembly.hdf5 -o OUT/ --no-subsample --plink --impute-method sample
$ ipyrad2 analysis snpex -d assembly.hdf5 -o OUT/ -i POPs.txt -g MINs.txt
"""
...
def _setup_snpex_subparser(
    ...
    """Add `ipyrad2 analysis snpex` subcommand parser."""
    ...
    core.add_argument(
        ...
        help="Path to an SNP-capable HDF5 file generated by ipyrad2 or `analysis vcf-to-hdf5`.",
    )
    core.add_argument(
